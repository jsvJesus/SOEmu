...
DEFAULT_CHARACTER_DELETE_SECONDS = (
    7 * 24 * 60 * 60
)

# STAGE 20:
# reject NaN/Inf and absurd/corrupted coordinates.
...
class MariaDBRepository:
    """
    Small synchronous repository for
    SOEmu's current single process.
    """
    ...
    def is_character_name_available(
        self,
        name: str,
    ) -> bool:
        name_key = normalize_identity(
            name
        )
    ...
    def set_tutorial_and_location(
        ...
        # STAGE 20:
        # corrupted values never reach MariaDB.
        position = (
            require_valid_world_position(
                position
            )
        )
    ...
    def update_position(
        ...
        # STAGE 20:
        # final protection for all runtime saves.
        position = (
            require_valid_world_position(
                position
            )
